<script lang="ts">
  const skills = [
    ...
    { src: '/site-static/logic-pro.webp', alt: 'Logic Pro' },
    { src: '/site-static/ableton-live.webp', alt: 'Ableton Live' },
    { src: '/site-static/renoise.webp', alt: 'Renoise' },
    { src: '/site-static/final-cut-pro.webp', alt: 'Final Cut Pro' },
    { src: '/site-static/motion.webp', alt: 'Motion' },
    { src: '/site-static/touch-designer.webp', alt: 'TouchDesigner' },
    ...
    <section class="mode-placeholder">
      ...
      <div class="about-links">
        <div class="about-link-row">
          <img class="about-avatar" src="/site-static/nattsu_real.webp" width="40" height="40" alt="プロフィール写真" />
          <a href="https://github.com/nattsu628878" target="_blank" rel="noopener noreferrer">GitHub: @nattsu628878</a>
        </div>
        <div class="about-link-row">
          <img class="about-avatar" src="/site-static/nattsu_320_320_tt.webp" width="40" height="40" alt="X 用アイコン" />
          <a href="https://x.com/nattsu_628878" target="_blank" rel="noopener noreferrer">X: @nattsu_628878</a>
        </div>
        <div class="about-link-row">
          <img class="about-avatar" src="/site-static/nattsu_320_320_tt.webp" width="40" height="40" alt="YouTube 用アイコン" />
